...
<head>
    ...
    <title>Login - {{ config('app.name', 'IEAMS') }}</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4">
                            <a href="{{ route('login') }}" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">IEAMS</span>
                            </a>
                        </div>
                        <!-- /Logo -->

                        <h4 class="mb-2">Welcome to IEAMS! 👋</h4>
                        <p class="mb-4">Please sign in to your account to manage attendance</p>
                        ...
                        <div class="demo-accounts">
                            <div class="alert alert-info" role="alert">
                                <strong>Superadmin:</strong> admin@ieams.test / password<br>
