...
<div class="card shadow-sm border-0">
    <div class="card-header d-flex align-items-center justify-content-between py-3">
        <h6 class="mb-0 fw-semibold"><i class="bi bi-person-gear me-1"></i> Edit User: {{ $user->name }}</h6>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-12">
                    <div class="alert alert-info py-2 mb-0 small">
                        <i class="bi bi-info-circle me-1"></i> Leave password fields blank to keep the current password.
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4">
                    <label class="form-label fw-semibold small">Linked Employee</label>
                    <select name="employee_id" class="form-select @error('employee_id') is-invalid @enderror">
                        <option value="">— None —</option>
                        @foreach($employees as $emp)
                        <option value="{{ $emp->id }}" {{ old('employee_id', $user->employee_id) == $emp->id ? 'selected' : '' }}>{{ $emp->employee_no }} — {{ $emp->full_name }}</option>
                        @endforeach
                    </select>
